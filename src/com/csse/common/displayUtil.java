...
public class displayUtil {
	...
	/**
	 * React employees arraylist of type Employee and displays data
	 * 
	 * @param employees
	 */
	public static void displayEmployee(ArrayList<Employee> employees) {
		System.out.println(CommonConstants.EMPLOYEE_ID + "\t\t" + CommonConstants.EMPLOYEE_FULLNAME + "\t\t"
				+ CommonConstants.EMPLOYEE_ADDRESS + "\t\t" + CommonConstants.EMPLOYEE_FACULTY_NAME + "\t\t"
